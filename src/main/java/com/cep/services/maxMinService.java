 ...
 * @author anushka
 */
//get product name>> send the price
@Path("/minMaxProduct")
public class maxMinService {
    ...
    public String maxMinProduct(@PathParam("maxMinVal") String maxMinVal) {
        //String val = maxVal;
        String userQuery = "select product from MyEventClass where price=" + maxMinVal;
